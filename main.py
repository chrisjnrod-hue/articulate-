...
async def startup():
    ...
    log("Startup config:", "BYBIT_USE_MAINNET=", BYBIT_USE_MAINNET, "TRADING_ENABLED=", TRADING_ENABLED, "PUBLIC_WS_URL=", PUBLIC_WS_URL, "MIN_CANDLES_REQUIRED=", MIN_CANDLES_REQUIRED, "SKIP_DIGIT_PREFIX=", SKIP_DIGIT_PREFIX, "MIN_SYMBOL_AGE_MONTHS=", MIN_SYMBOL_AGE_MONTHS)
