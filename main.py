# main.py
# Bybit MACD multi-timeframe scanner — final full file
...
# ---------- PublicWebsocketManager (defined before startup) ----------
...
# ---------- Helpers (resilient_public_get, bybit_signed_request, etc.) ----------
...
# ---------- SQLite init, migrations, atomic helpers ----------
async def init_db():
    global db
