# services.py - COMPLETE WITH MTF EVALUATION FIX
...
async def add_signal(sig: Dict[str, Any]) -> bool:
    ...
    async with lock:
        ...
        if stype == "root": 
            try:
                from scanners import _evaluate_root_signal_for_entry
                asyncio.create_task(_evaluate_root_signal_for_entry(sig))
            except Exception as e:
